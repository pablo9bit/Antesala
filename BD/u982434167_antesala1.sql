...
-- Tiempo de generación: 17-11-2021 a las 14:35:27
...
INSERT INTO `UsuariosOrganizaciones` (`id`, `idusuario`, `razon_social`, `logo`, `descripcion`, `ubicacion`, `coordX`, `coordY`, `idestado`, `url`, `motivodesactivado`) VALUES
(1, 12, '9bit', '', 'jjjnnn', 'jjjj', '', '', 2, 'jjj', '');
