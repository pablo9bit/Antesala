...
const Eventos = () => {
  return (
    <section id="eventos" className="mb-400">
      <div className="container">
        <div className="row">
          <div
            id="recipeCarousel"
            className="carousel slide wow bounceInUp"
                ...
                <div className="col-md-4 mb-4 pe-3 ps-3">
                  <div className="box-eventos text-center">
                    <div className="img-evento">
                      ...
                      <img
                        src="assets/img/img-teatro-01.png"
                        width="100%"
                        alt=""
                      />
                    </div>
                    ...
                    <p className="precio fc-violeta mt-2">
                      $800<span>$900</span>
                    </p>
                    <a href="#" className="btn btn-comprar mb-4">
                      Comprar
                    </a>
                  </div>
                </div>
                ...
                <div className="col-md-4 mb-4 pe-3 ps-3">
                  <div className="box-eventos text-center">
                    <div className="img-evento">
                      <span className="tag-evento">Teatro</span>
                      <img
                        src="assets/img/img-teatro-02.png"
                        width="100%"
                        alt=""
                      />
                    </div>
                    ...
                    <a href="#" className="btn btn-agotado mb-4">
                      Agotado
                    </a>
                  </div>
                </div>
                ...
                <div className="col-md-4 mb-4 pe-3 ps-3">
                  <div className="box-eventos text-center">
                    <div className="img-evento">
                      <span className="tag-evento">Teatro</span>
                      <img
                        src="assets/img/img-teatro-03.png"
                        width="100%"
                        alt=""
                      />
                    </div>
